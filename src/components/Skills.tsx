...
import { SiSpringboot, SiSpringsecurity, SiTypescript, SiDocker , SiAmazonwebservices, SiMysql  } from "react-icons/si";
    ...
    return(
        <div className=" max-w-[650px] mx-auto flex flex-col justify-center px-4 text-gray-200 pb-8 md:py-12" id="skills">
            ...
            <p className="text-center mb-8">
                trabaje en varios proyectos Fullstack. Miralos  <a href="#" className="underline">aqui</a>  
            </p>
