                ...
                <div className="grid md:grid-cols-2 place-items-center">
                    <div>
                        <div className="text-gray-300 my-3">
                            ...
                            <p className="text-justify leading-7 w-11/12 mx-auto" >Lorem ipsum dolor sit ametconsectetur adipisicing elit. 
                                Quasi rem recusandae earum. Beatae nemo cum nihil neque voluptas e
                                ius pariatur consectetur repellendus, 
                                dolorum praesentium tempora animi vel quos ipsam maiores.</p>
                        </div>
                        ...
                        <div className="flex mt-10 items-center gap-7">
                            ...
                            <div className="bg-gray-800/40 p-5 rounded-lg">
                                <h3 className="md:text-4xl text-2xl font-semibold text-white">67
                                    <span>+</span>
                                </h3>
